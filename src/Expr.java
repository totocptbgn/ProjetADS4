...
public abstract class Expr {
    ...
    public int evalInt(Map<String,Integer> hm) throws IOException { throw new IOException("Pas un entier"); }
    public boolean evalBool(Map<String,Boolean> hm) throws IOException { throw new IOException("Pas un booleen"); }
